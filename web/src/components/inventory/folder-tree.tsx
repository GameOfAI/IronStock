/**
 * FolderTree — sol panel klasör ağacı.
 *
 * Root folder'ları `useRootFolders` ile çeker; çocuklar lazy yüklenir.
 * Expand state lokal `Set<string>`'te tutulur (URL'e koymadık — derin
 * ağaçta URL şişer; selection URL'de zaten var, expand path'i değil).
 */
